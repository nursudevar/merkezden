...
const CATEGORY_NAME = "Sürücü Kursu";
const FALLBACK_CATEGORY_SLUG = "surucu-kursu";

export default function SurucuKursuPageClient() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const byKey = rows.find((r) => {
        ...
        return nk.includes("surucu kursu");
      });
  ...
  return (
      <CategoryPageLayout
        ...
        subtitle="Sürücü kurslarını ve ehliyet eğitim kurumlarını keşfedin."
        results={results}
        isLoading={isLoading}
        errorMessage={error}
        schoolModeProps={{
