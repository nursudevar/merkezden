...
const INSTRUCTOR_ANNOUNCEMENT_ROW_SELECT =
  "id, instructor_id, owner_auth_id, title, content, image_url, image_path, link_url, announcement_tag, il_id, ilce_id, is_active, created_at, updated_at";
